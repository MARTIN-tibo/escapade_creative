  ...
  return (
    <section className="section helene-section" aria-labelledby="helene-title">
      <div className="container split-panel reverse">
        ...
        <div className="image-frame portrait"><MultiImage name="helene-huret.jpg" alt="Portrait d’Hélène Huret, journaliste culinaire et hôte de l’Escapade Créative" /></div>
      </div>
    </section>
  );
}
